...
import { Layers, Zap, Shield, Sparkles, CheckCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-12 shadow-2xl transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          ...
          <div className="text-center mt-12 pt-8 border-t border-white/10">
            ...
            <button className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#f2413b] to-red-600 text-white rounded-xl font-semibold hover:shadow-2xl hover:shadow-[#f2413b]/50 transition-all duration-300 hover:scale-105 active:scale-95">
